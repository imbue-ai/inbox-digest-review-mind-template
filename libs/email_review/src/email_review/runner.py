...
DATA_PATH = Path("runtime/email_review/data.json")
SAVED_PATH = Path("runtime/email_review/saved_threads.jsonl")
STARRED_PATH = Path("runtime/email_review/starred_threads.jsonl")
...
BUCKET_OVERRIDES_PATH = Path("runtime/email_review/bucket_overrides.json")
...
MOVE_LOG_PATH = Path("runtime/email_review/move_log.jsonl")
# Repo root is resolved from this file's location (.../libs/email_review/src/
# email_review/runner.py -> parents[4]) so the refresh subprocesses run with
