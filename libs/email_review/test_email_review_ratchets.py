...
def test_prevent_broad_exception_catch() -> None:
    # Two deliberate catch-alls in runner.py request handlers (marked
    # `# noqa: BLE001`) that surface the error message to the user instead
    # of returning a 500. Baseline for this inherited app; may only decrease.
