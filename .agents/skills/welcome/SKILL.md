---
name: welcome
description: "Greet the user when a new project starts. This mind was created from the Inbox Digest & Review template, so the welcome introduces that template and immediately starts the adaptation conversation."
---

# Welcome the user (template: Inbox Digest & Review)
